...
public class GuiFarmerSignup extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
        ...
        int stringHeight = fontRenderer.listFormattedStringToWidth(s, bgWidth).size() * fontRenderer.FONT_HEIGHT;
        GuiHelper.drawDefaultBackground(xPos, height - stringHeight - 10, bgWidth, bgHeight);
        fontRenderer.drawSplitString(s, xPos + 5, height - stringHeight - 5, bgWidth - 10, 4210752);
    }
