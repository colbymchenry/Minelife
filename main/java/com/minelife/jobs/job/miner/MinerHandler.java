...
public class MinerHandler extends NPCHandler {
    ...
    public List<SellingOption> getSellingOptions() {
        ...
        sellingOptions.add(new SellingOption(new ItemStack(Item.getByNameOrId("immersiveengineering:ore"), 1, 0), 128));
        sellingOptions.add(new SellingOption(new ItemStack(Item.getByNameOrId("immersiveengineering:ore"), 1, 1), 128));
        sellingOptions.add(new SellingOption(new ItemStack(Item.getByNameOrId("immersiveengineering:ore"), 1, 2), 512));
        sellingOptions.add(new SellingOption(new ItemStack(Item.getByNameOrId("immersiveengineering:ore"), 1, 3), 512));
        sellingOptions.add(new SellingOption(new ItemStack(Item.getByNameOrId("immersiveengineering:ore"), 1, 4), 1024));
        sellingOptions.add(new SellingOption(new ItemStack(Item.getByNameOrId("immersiveengineering:ore"), 1, 5), 4096));
        sellingOptions.add(new SellingOption(new ItemStack(Item.getByNameOrId("immersiveengineering:ore"), 1, 7), 1280));
