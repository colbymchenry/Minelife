...
public class AIShootPrison extends EntityAIBase {
    private final EntityCop entity;
    ...
    public AIShootPrison(EntityCop p_i47515_1_, double p_i47515_2_, int p_i47515_4_, float p_i47515_5_) {
    ...
    public void updateTask() {
        ...
        if (entitylivingbase != null) {
            ...
            if (entitylivingbase instanceof EntityPlayer) {
                if (Prison.getPrison(entity.getPosition()) != null && Prison.getPrison(entitylivingbase.getPosition()) != null) {
                    if (Prisoner.isPrisoner(entitylivingbase.getUniqueID()) || ModPolice.isCop(entitylivingbase.getUniqueID())) {
                        return;
                    }
                }
            }
            ...
            if (true) {
                if (!flag && this.seeTime < -60) {
                    ...
                    if (--this.attackTime <= 0) {
                        ...
                        if (entitylivingbase instanceof EntityPlayer)
                            this.entity.setChasingPlayer((EntityPlayer) entitylivingbase);
                        this.entity.setAttackTarget(entitylivingbase);
                        this.attackTime = EnumGun.values()[this.entity.getHeldItemMainhand().getMetadata()].fireRate / (int) MathHelper.nextDouble(entity.world.rand, 7, 15);
                    }
                }
