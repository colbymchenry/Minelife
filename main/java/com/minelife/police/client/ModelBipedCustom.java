...
public class ModelBipedCustom extends ModelBiped {
    ...
    public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
        ...
        boolean arrested = p_78088_1_.getEntityData().hasKey("arrested") ? p_78088_1_.getEntityData().getBoolean("arrested") : false;
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
        boolean arrested = p_78087_7_.getEntityData().hasKey("arrested") ? p_78087_7_.getEntityData().getBoolean("arrested") : false;

        this.bipedHead.rotateAngleY = p_78087_4_ / (180F / (float) Math.PI);
        this.bipedHead.rotateAngleX = p_78087_5_ / (180F / (float) Math.PI);

        if(arrested) {
            this.bipedHead.rotateAngleY = 12;
            this.bipedHead.rotateAngleX = 25;
        }

        this.bipedHeadwear.rotateAngleY = this.bipedHead.rotateAngleY;
        this.bipedHeadwear.rotateAngleX = this.bipedHead.rotateAngleX;

        // keeps arms and legs still
        if (arrested)
            p_78087_2_ = 0;
        ...
        /**
         * CONTROLLS ARM SWAY WHEN IDLE
         */
        float rotateZ = 0.09F, rotateX = 0.067F;
        float rotateZCuffs = 0F, rotateXCuffs = 0F;
        if (arrested) {
            rotateZ = 0;
            rotateX = 0;
            rotateZCuffs = -0.5F;
        ...
        this.bipedRightArm.rotateAngleZ += MathHelper.cos(p_78087_3_ * 0.09F) * 0.05F + rotateZCuffs;
        this.bipedLeftArm.rotateAngleZ -= MathHelper.cos(p_78087_3_ * 0.09F) * 0.05F + rotateZCuffs;
        this.bipedRightArm.rotateAngleX += MathHelper.sin(p_78087_3_ * 0.067F) * 0.05F + rotateXCuffs;
        this.bipedLeftArm.rotateAngleX -= MathHelper.sin(p_78087_3_ * 0.067F) * 0.05F + -rotateXCuffs;
