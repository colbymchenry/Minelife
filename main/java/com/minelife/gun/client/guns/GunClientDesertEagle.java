...
public class GunClientDesertEagle extends ItemGunClient {

    public GunClientDesertEagle(ItemGun gun) {
        super(gun);
    }
    ...
    public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object... data) {
        GL11.glPushMatrix();
        {
            if (type == IItemRenderer.ItemRenderType.EQUIPPED_FIRST_PERSON) {
                ...
                GL11.glTranslatef(0.1f + getAnimation().posX(), -1f + getAnimation().posY(), -1f + getAnimation().posZ());
