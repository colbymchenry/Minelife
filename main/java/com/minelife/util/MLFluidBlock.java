...
public class MLFluidBlock extends BlockFluidClassic {

    private Color fogColor;

    public MLFluidBlock(Fluid parFluid, Material parMaterial, String name, Color fogColor) {
        super(parFluid, parMaterial);
        setRegistryName(Minelife.MOD_ID, name);
        setUnlocalizedName(Minelife.MOD_ID + ":" + name);
    ...
    public Vec3d getFogColor(World world, BlockPos pos, IBlockState state, Entity entity, Vec3d originalColor, float partialTicks) {
        return new Vec3d(fogColor.getRed(), fogColor.getGreen(), fogColor.getBlue());
    }
