...
public class AIEMTRegroup extends EntityAIBase {
    ...
    public AIEMTRegroup(EntityEMT cop) {
        this.entity = cop;
        setMutexBits(7);
    }
    ...
    public BlockPos getRandomRegroupPos() {
        if (!ModEMT.getConfig().contains("EMTSpawnPoints")) return null;
        List<String> regroups = ModEMT.getConfig().getStringList("EMTSpawnPoints");
