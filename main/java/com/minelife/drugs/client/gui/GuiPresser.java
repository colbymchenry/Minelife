...
//    private TileEntityPresser tile;
//
//    public GuiPresser(EntityPlayer player, TileEntityPresser tile) {
//        super(new ContainerPresser(player, tile));
//        this.tile = tile;
