...
public class BlockPyrolusiteOre extends Block {
    ...
    public BlockPyrolusiteOre() {
        super(Material.ROCK);
        setRegistryName(Minelife.MOD_ID, "pyrolusite_ore");
        setUnlocalizedName(Minelife.MOD_ID + ":pyrolusite_ore");
        setHardness(3);
        setResistance(15);
    ...
    public void registerModel(ItemModelMesher mesher) {
        ...
        ModelResourceLocation model = new ModelResourceLocation(Minelife.MOD_ID + ":pyrolusite_ore", "inventory");
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return ModDrugs.itemPyrolusite;
    }
    ...
    public static class Generator implements IWorldGenerator {
        ...
        public Generator() {
            worldGenerator = new WorldGenMinable(ModDrugs.blockPyrolusiteOre.getDefaultState(), 7);
        }
