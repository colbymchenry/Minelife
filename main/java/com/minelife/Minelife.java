...
@Mod(modid = Minelife.MOD_ID, name = Minelife.NAME, version = Minelife.VERSION, dependencies = "required-after:immersiveengineering;", acceptableRemoteVersions = "3.1")
public class Minelife {

    public static final String MOD_ID = "minelife", VERSION = "3.1", NAME = "Minelife";
