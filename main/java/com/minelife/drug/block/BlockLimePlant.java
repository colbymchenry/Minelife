...
public class BlockLimePlant extends AbstractCrop {

    private static BlockLimePlant instance;
    private static Random random = new Random();

    private BlockLimePlant()
    {
    }

    public static BlockLimePlant instance() {
        if(instance == null) instance = new BlockLimePlant();
        return instance;
    }
    ...
    {
        icon_array[0] = icon_register.registerIcon(Minelife.MOD_ID + ":lime_stage_0");
        icon_array[1] = icon_register.registerIcon(Minelife.MOD_ID + ":lime_stage_0");
        icon_array[2] = icon_register.registerIcon(Minelife.MOD_ID + ":lime_stage_1");
        icon_array[3] = icon_register.registerIcon(Minelife.MOD_ID + ":lime_stage_1");
        icon_array[4] = icon_register.registerIcon(Minelife.MOD_ID + ":lime_stage_2");
