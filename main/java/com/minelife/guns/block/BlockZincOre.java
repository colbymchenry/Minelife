package com.minelife.guns.block;
...
public class BlockZincOre extends Block {
    ...
    public void registerModel(ItemModelMesher mesher) {
        ...
        ModelResourceLocation model = new ModelResourceLocation(Minelife.MOD_ID + ":zinc_ore", "inventory");
    ...
    public static class Generator implements IWorldGenerator {
        ...
        public Generator() {
            worldGenerator = new WorldGenMinable(ModGuns.blockZincOre.getDefaultState(), 5);
        }
        ...
        public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
            ...
            runGenerator(worldGenerator, world, random, chunkX, chunkZ, 40, 0, 60);
        }
