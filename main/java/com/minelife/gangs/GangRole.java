...
public enum GangRole {
    ...
    YOUNGER(TextFormatting.GREEN, GangPermission.DEPOSIT_MONEY, GangPermission.JOIN_FIGHTS, GangPermission.TELEPORT_HOME, GangPermission.REGROUP, GangPermission.INVITE),
    ELDER(TextFormatting.GOLD, GangPermission.DEPOSIT_MONEY, GangPermission.JOIN_FIGHTS, GangPermission.TELEPORT_HOME, GangPermission.REGROUP, GangPermission.SETHOME_DELHOME,
